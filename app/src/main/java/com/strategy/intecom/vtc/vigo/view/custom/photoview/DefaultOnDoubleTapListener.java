 ...
 * <p>&nbsp;</p>
 * To be used via {@link com.strategy.intecom.vtc.vigo.view.custom.photoview#(GestureDetector.OnDoubleTapListener)}
 */
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    public boolean onDoubleTap(MotionEvent ev) {
        ...
        try {
            ...
            AppCore.showLog(" ArrayIndexOutOfBoundsException | IllegalArgumentException : " + e.getMessage());
        }
